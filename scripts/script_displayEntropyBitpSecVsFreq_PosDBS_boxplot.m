...
%     
    ...
    %% Calculate PSOTDBS entropy, normalized by bit/spike
...
BitpSec = FRposCorr .* Hpos;

% Append data of interest to Tselect
N = [Tselect, table(FRposCorr), table(Hpos), table(BitpSec)];
