function runEntropyDirectISI_byCell(pipeParams)
% Run Run ISI-based Entropy Estimation for each cell labelled as 
...
deltaH_Cswp = calcDeltaEntropyISI_allTableRows(R_modNeurons_Cswp);

deltaH_Fswp = calcDeltaEntropyISI_allTableRows(R_modNeurons_Fswp);
