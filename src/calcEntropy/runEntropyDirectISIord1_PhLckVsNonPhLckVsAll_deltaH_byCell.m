function runEntropyDirectISIord1_PhLckVsNonPhLckVsAll_deltaH_byCell(pipeParams)
...
% TO-DO
% - add in a default case for when pipeParams.CsweepXLim is not specified
% in the function input structure
% - add in a default case for when pipeParams.FsweepYLim is not specified
% in the function input structure
