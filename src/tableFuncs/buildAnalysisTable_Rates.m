function [rateDataSweep] = buildAnalysisTable_Rates(pipeParams)
...
IntTableName = ['RateBins_', num2str(totTime), 'sec_', num2str(binWidth), ...
...
if ~exist([pipeParams.intDataPn, '\', IntTableName, '.mat']) 
    ...
    save([pipeParams.intDataPn, '\', 'RateBins_60sec_1secBins_', ...
          pipeParams.subjID], 'RateBins');
    

else
    load([pipeParams.intDataPn, '\', 'RateBins_60sec_1secBins_', ...
          pipeParams.subjID], 'RateBins');
