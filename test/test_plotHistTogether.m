% preliminary script for reading in one trial of data and 3d plotting its
% isi results
...
iNex = 1;
 % LOAD each Nexfile and get spike times
    ...
    [isiLogHist, binEdges, binIdx] = isiLogBinned(isiDBS, BINS_PER_DECADE)
...
%%  plot it as one spot in plot3

x1 = xS; % rescale from ms to seconds
y1 = ones(numel(xS), 1);
z1 = yS;
