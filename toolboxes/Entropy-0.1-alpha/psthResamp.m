function [PSTH] = psthResamp(evTimes,refTimes,binEdges, resampNum, varargin)
...
toc
%% RESAMPLE times from psthTimes, with replacement

psthResamped = datasample(psthTimes, resampNum, 'Replace', true);


%% Final psth 

[psthCount,~] = histcounts(psthResamped, binEdges);
