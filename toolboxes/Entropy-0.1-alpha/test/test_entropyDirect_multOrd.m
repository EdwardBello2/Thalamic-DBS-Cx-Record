...
scale = 1000; % to rescale bins from seconds to ms when plotting results


% 
H_PRE = entropyDirect_multOrder(preDBSspks, binPD, nOrders)

H_DBS = entropyDirect_multOrder(DBSspks, binPD, nOrders)
