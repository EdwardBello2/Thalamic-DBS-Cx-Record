function [result] = writeNexFilev2(nexFile, fileName)
...
for i = 1:waveCount
    ...
    if(isfield(wave, 'ADtoMV'))
        nexFile.waves{i}.ADtoMV = wave.ADtoMV;
    else
...
for i = 1:contCount
    ...
    if(isfield(contvar, 'ADtoMV'))
        nexFile.contvars{i}.ADtoMV = contvar.ADtoMV;
    else
